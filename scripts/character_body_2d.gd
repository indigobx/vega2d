...
var dress_frames = {
  "nude": preload("res://sprites/vega-nude.tres"),
  "training": preload("res://sprites/vega-training.tres")
}
var rocket_scene = preload("res://scenes/projectiles/mini_rocket.tscn")
var weapon_mag_scene = preload("res://scenes/debris/weapon_mag.tscn")
var bullet_scene = preload("res://scenes/projectiles/bullet.tscn")
var casing_scene = preload("res://scenes/debris/casing.tscn")
var smartshell_scene = preload("res://scenes/projectiles/smart_shell.tscn")
var marker_scene = preload("res://scenes/ui/marker.tscn")
